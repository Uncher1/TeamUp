...
const Map<String, Map<String, String>> _strings = {
  'en': {
    ...
    'feed.addImage': 'Add a photo',
    'feed.changeImage': 'Change photo',
    ...
    'proj.matchWeight': 'Skills vs interests importance',
    'proj.matchWeightHint': 'Choose how much skills count versus interests when matching teammates.',
    'proj.skillsShort': 'Skills',
    'proj.interestsShort': 'Interests',
    'proj.themes': 'Topics',
    ...
    'ep.isStudent': "I'm a student",
    'ep.isStudentHint': 'Adds an academic section (school, field of study, year) to your profile.',
  ...
  'fr': {
    ...
    'feed.addImage': 'Ajouter une photo',
    'feed.changeImage': 'Changer la photo',
    ...
    'proj.matchWeight': 'Importance compétences / intérêts',
    'proj.matchWeightHint': 'Choisis le poids des compétences par rapport aux intérêts pour le matching des coéquipiers.',
    'proj.skillsShort': 'Compétences',
    'proj.interestsShort': 'Intérêts',
    ...
    'chat.maxAttachments': 'Jusqu’à {n} pièces jointes par message.',
    'chat.recordVoice': 'Enregistrer un message vocal',
    'chat.recording': 'Enregistrement…',
    'gif.button': 'Envoyer un GIF',
    'gif.searchHint': 'Rechercher sur GIPHY',
    'gif.error': 'Impossible de charger les GIFs.',
    'gif.empty': 'Aucun GIF trouvé.',
    'gif.lastGif': 'GIF',
    ...
    'ep.isStudent': 'Je suis étudiant(e)',
    'ep.isStudentHint': 'Ajoute une section académique (école, filière, année) à ton profil.',
