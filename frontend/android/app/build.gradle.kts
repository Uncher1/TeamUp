...
android {
    namespace = "com.team28.teamup"
    compileSdk = flutter.compileSdkVersion
    ndkVersion = flutter.ndkVersion

    compileOptions {
        // Required by the ota_update plugin (uses Java 8+ APIs on older devices).
    ...
    defaultConfig {
        ...
        applicationId = "com.team28.teamup"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // google_sign_in (Credential Manager) requires API 24+.
    ...
    buildTypes {
        release {
            ...
            // fall back to debug so `flutter run --release` still works.
