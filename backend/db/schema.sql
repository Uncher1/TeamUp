...
CREATE TABLE IF NOT EXISTS messages (
  ...
  attachment_type VARCHAR(10) NULL,    -- 'image' | 'file' | 'audio' | 'poll' (single)
  attachment_name VARCHAR(255) NULL,
  attachment_data LONGTEXT NULL,        -- base64 data URL (single attachment)
  attachments     JSON NULL,            -- up to 10 images/files in one message
  created_at      TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
